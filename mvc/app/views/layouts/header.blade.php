					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown">
								<a href="{{BASE_URL.'category'}}" class="nav-link " >Cửa Hàng</a>
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link" href="{{BASE_URL.'category'}}">Danh mục cửa hàng</a></li>
									<li class="nav-item"><a class="nav-link" href="{{BASE_URL.'detail-product'}}">Chi tiết sản phẩm</a></li>
									<li class="nav-item"><a class="nav-link" href="{{BASE_URL.'cart'}}">Giỏ Hàng</a></li>
								</ul>
							</li>
						
								<li class="nav-item"><a class="nav-link" href="{{BASE_URL.'blog'}}">Bài Viết</a></li>
						...
						@if (isset($_SESSION[AUTH]))
							...
							@if ($_SESSION[AUTH]['role']== ADMIN_ROLE)
								<li class="nav-item"><a class="nav-link" href="{{BASE_URL.'admin'}}">Trang Quản Trị</a></li>
							@endif	
						...
						@else
							...
							<li class="nav-item submenu dropdown"><a class="nav-link" href="{{BASE_URL.'login'}}">Đăng Nhập</a>
							</li>
						@endif
		...
		<div class="search_input" id="search_input_box">
			<div class="container">
				<form class="d-flex justify-content-between" method="GET">
					...
					@isset($_GET['keyword'])
					value="{{$_GET['keyword']}}"
					@endisset id="search_input" name="keyword" placeholder="Tìm kiếm ...">
